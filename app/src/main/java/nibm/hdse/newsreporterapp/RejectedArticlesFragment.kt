...
class RejectedArticlesFragment : Fragment() {
...
class RejectedArticlesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Fetch rejected articles from Firebase
    ...
    private fun fetchRejectedArticles() {
        FirebaseHelper.fetchArticlesByStatus(
            "Rejected", // Fetch articles with status "Rejected"
